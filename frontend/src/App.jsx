...
/**
 * Backend contract (replace this stub when ready):
 *
 *   POST /api/analyse
 *   Body:     { pages: string[] }
 *   Response: { suggestions: Array<{ page, start, end, type, severity, message, suggestion }> }
 */
async function fetchSuggestionsFromBackend(pages) {
  await new Promise((r) => setTimeout(r, 1200));
  // Return mock suggestions that are still in-range for the current pages
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        {/* Editor pane — grey canvas background like a real PDF viewer */}
        <div style={{
          flex: 1,
          overflowY: "auto",
          background: isDark ? "#23272f" : "#e8e6e1",
          padding: "40px 32px",
        }}>
          {/* Legend bar */}
          <div style={{
